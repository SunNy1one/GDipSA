...
# CREATE TABLE PurchaseSoftware (PurchaseID VARCHAR(10), SoftwareID VARCHAR(10), ActivationCode VARCHAR(36), PRIMARY KEY(PurchaseID, SoftwareID, ActivationCode), FOREIGN KEY(PurchaseID) REFERENCES Purchase(PurchaseID), FOREIGN KEY(SoftwareID) REFERENCES Software(SoftwareID));
...
-- INSERT INTO PurchaseSoftware (PurchaseId, SoftwareId, ActivationCode) VALUES ('2', '1', 'i8bc73fe-b1f4-4736-8c4a-e7e3fc53276c');
...
-- INSERT INTO PurchaseSoftware (PurchaseId, SoftwareId, ActivationCode) VALUES ('7', '7', '45e82447-3f05-420c-b94a-94834a4ef242');
-- INSERT INTO PurchaseSoftware (PurchaseId, SoftwareId, ActivationCode) VALUES ('6', '5', 'b2ee51d2-ecf5-4eb6-87a4-067fc744030b');
-- INSERT INTO PurchaseSoftware (PurchaseId, SoftwareId, ActivationCode) VALUES ('7', '9', 'bf278667-4c49-4886-bbd8-dbe36807b37b');
-- INSERT INTO PurchaseSoftware (PurchaseId, SoftwareId, ActivationCode) VALUES ('7', '10', 'c8bc73fe-b1f4-4736-8c4a-e7e3fc53276c');

-- SELECT * FROM PurchaseSoftware;

SELECT PurchaseId, DateOfPurchase FROM Purchase WHERE UserId = "3";

SELECT s.SoftwareId, s.SoftwareName, s.ImageURL, s.Descr, ps.ActivationCode FROM PurchaseSoftware ps inner join Software s on ps.SoftwareId = s.SoftwareId where ps.PurchaseId = "7";
SELECT SoftwareID FROM Software WHERE SoftwareName like '%Data%' or Descr like '%Data%';